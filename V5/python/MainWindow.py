# Form implementation generated from reading ui file './ui/v5.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(0, 0, 900, 591))
        ...
        self.xDisplay_a.setGeometry(QtCore.QRect(10, 10, 121, 41))
        font = QtGui.QFont()
        ...
        self.yDisplay_a.setGeometry(QtCore.QRect(10, 10, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(24)
        ...
        self.zDisplay_a.setGeometry(QtCore.QRect(10, 10, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(24)
        ...
        self.yDisplay_b.setGeometry(QtCore.QRect(10, 10, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(24)
        ...
        self.xDisplay_b.setGeometry(QtCore.QRect(10, 10, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(24)
        ...
        self.zDisplay_b.setGeometry(QtCore.QRect(10, 10, 121, 41))
        font = QtGui.QFont()
        font.setPointSize(24)
        ...
        self.lambdaLabel.setGeometry(QtCore.QRect(190, 90, 21, 21))
        ...
        self.osaConnectButton.setGeometry(QtCore.QRect(20, 40, 101, 41))
        self.osaConnectButton.setObjectName("osaConnectButton")
        self.groupBox = QtWidgets.QGroupBox(parent=self.osaTab)
        self.groupBox.setGeometry(QtCore.QRect(20, 400, 101, 131))
        ...
        self.osaSetLinButton.setGeometry(QtCore.QRect(20, 220, 101, 41))
        self.osaSetLinButton.setObjectName("osaSetLinButton")
        self.osaSetLogButton = QtWidgets.QPushButton(parent=self.osaTab)
        self.osaSetLogButton.setGeometry(QtCore.QRect(20, 280, 101, 41))
        self.osaSetLogButton.setObjectName("osaSetLogButton")
        self.osaSaveButton = QtWidgets.QPushButton(parent=self.osaTab)
        self.osaSaveButton.setGeometry(QtCore.QRect(20, 340, 101, 41))
        self.osaSaveButton.setObjectName("osaSaveButton")
        self.printButton = QtWidgets.QPushButton(parent=self.osaTab)
        self.printButton.setGeometry(QtCore.QRect(800, 540, 81, 16))
        font = QtGui.QFont()
        font.setPointSize(6)
        self.printButton.setFont(font)
        self.printButton.setObjectName("printButton")
        self.classicOSAButton = QtWidgets.QRadioButton(parent=self.osaTab)
        self.classicOSAButton.setGeometry(QtCore.QRect(20, 10, 121, 21))
        self.classicOSAButton.setChecked(True)
        self.classicOSAButton.setObjectName("classicOSAButton")
        self.yokoOSAButton = QtWidgets.QRadioButton(parent=self.osaTab)
        self.yokoOSAButton.setGeometry(QtCore.QRect(130, 10, 121, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.classicOSAButton.setText(_translate("MainWindow", "Classic OSA"))
        self.yokoOSAButton.setText(_translate("MainWindow", "Yokogawa OSA"))
