...
from OSA import OSA
from Yokogawa_OSA import Yokogawa_OSA
import numpy as np
...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def setupSignals(self):
        ...
        # self.classicOSAButton.clicked.connect(self.)
...
class PiezoSettings(QtWidgets.QWidget, Ui_PiezoSettings):
    def __init__(self, *args, obj=None, **kwargs):
        ...
        try:
            comports_config = open('config/comports.txt', 'r')
        except:
            comports_config = open('config/comports.txt', 'a')
